...
from parameters import SOURCES_DIAMOR, BOUNDARIES_DIAMOR
    ...
    for day in ["06", "08"]:
        ...
        for group in day_groups:
            ...
            for members in group["members"]:
                members["trajectory_source_to_sink"] = (
                    compute_trajectory_source_to_sink(
            ...
            if source_to_sink not in source_to_sink_groups[day]:
                source_to_sink_groups[day][source_to_sink] = []

            source_to_sink_groups[day][source_to_sink] += [group]
